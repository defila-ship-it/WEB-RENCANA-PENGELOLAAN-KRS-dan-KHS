...
<div class="text-center mb-6">
    ...
    <p class="text-white/60 text-sm">Selamat datang, {{ auth()->user()->name ?? 'Admin' }}</p>
</div>
...
<div class="grid grid-cols-1 gap-4">
    ...
    <div class="bg-white/10 backdrop-blur border border-white/20 rounded-xl p-4 shadow-lg hover:scale-[1.02] transition">
        <h2 class="text-white font-semibold">Manajemen User</h2>
        <p class="text-white/60 text-sm">Kelola data admin, dosen, mahasiswa</p>
    </div>

    <!-- Card 2 -->
    <div class="bg-white/10 backdrop-blur border border-white/20 rounded-xl p-4 shadow-lg hover:scale-[1.02] transition">
        <h2 class="text-white font-semibold">Data Akademik</h2>
        <p class="text-white/60 text-sm">Kelola KRS & KHS</p>
    </div>
